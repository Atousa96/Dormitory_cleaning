...
<body class="bg-gray-200">
                    ...
                    <div class="container-fluid ps-2 pe-0">
                        ...
                        <div class="dropdown mx-lg-auto">
                            <button class="btn mb-0 dropdown-toggle bg-gradient-primary w-100 rounded-pill"
                                ...
                                <i class="fas fa-house-user opacity-6 me-1"></i> Housekeeper Login
                            </button>
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-100" style="background-image: url('./assets/img/hbg.jpg');">
                        ...
                        <div class="card z-index-0 fadeIn3 fadeInBottom ">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 ">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                    <h4 class="text-white font-weight-bolder text-center mt-2 mb-0"> Housekeeper Login </h4>
                                    <div class="row mt-3">
                            ...
                            <div class="card-body">
                                <form action="" method="POST" autocomplete="off" class="text-start">
                                    ...
                                    <div class="input-group input-group-outline my-3">
                                        <input name="workerID" type="number" id="rollnumber" class="form-control"
                                            required>
                                        <label class="form-label" for="rollnumber">WorkerID</label>
                                    </div>
                                    <div class="input-group input-group-outline my-3">
                                        <input name="workerPassword" type="password" id="password" class="form-control"
                                            required>
                                    ...
                                    <button name="studentLogin" type="submit"
                                        class="btn bg-gradient-primary w-100 my-4 mb-2">Continue</button>
                                </form>
                            </div>
                        </div>
                    </div>
