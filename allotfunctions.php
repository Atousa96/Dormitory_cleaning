<?php
  ...
  function getRequestCount($db){
    ...
    $query_request_count = "Select count(*) from cleanrequest cr inner join student s on cr.rollnumber=s.rollnumber where req_status=0";
  ...
  function getComplantCount($db){
    $hostel_name = substr($_SESSION['username'], -1);
    $query_complaint_count = "Select count(*) from complaints cr inner join student s on cr.rollnumber=s.rollnumber ";
  ...
  function getSuggestionCount($db){
    $hostel_name = substr($_SESSION['username'], -1);
    $query_suggestion_count = "Select count(*) from suggestions cr inner join student s on cr.rollnumber=s.rollnumber";
