                    ...
                    <div class="container-fluid ps-2 pe-0">
                        ...
                        <div class="dropdown mx-lg-auto">
                            ...
                            <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item text-left" href="login.php"> <i
                                            class="fa fa-user opacity-6 text-dark me-1"></i> Student login</a></li>
                                <!-- <li><a class="dropdown-item text-left" href="alogin.php">   <i class="fas fa-user-circle opacity-6 text-dark me-1"></i> Admin login</a></li> -->
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST" autocomplete="off" class="text-start">
                                    ...
                                    <div class="input-group input-group-outline my-3">
                                        <input type="text" name="adminUsername" id="rollnumber" class="form-control"
                                            required>
                                        <label class="form-label" for="rollnumber">Username</label>
                                    </div>
                                    <div class="input-group input-group-outline mb-3">
                                        <input type="password" name="adminPassword" id="password" class="form-control"
                                            required>
